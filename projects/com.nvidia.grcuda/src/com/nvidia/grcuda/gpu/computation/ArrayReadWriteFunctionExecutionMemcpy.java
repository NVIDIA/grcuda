 ...
 */
public class ArrayReadWriteFunctionExecutionMemcpy extends ArrayReadWriteFunctionExecution {
    /**
     * A memory pointer from which data copied to the array are retrieved, or memory pointer to which data are written;
     */
    private final long pointer;

    public ArrayReadWriteFunctionExecutionMemcpy(AbstractArray array, DeviceArrayCopyFunction.CopyDirection direction, long numElements, long pointer) {
