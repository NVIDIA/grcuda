 ...
 */
public abstract class RetrieveStream {
    abstract CUDAStream retrieve();

    /**
     * Initialize the class with the provided stream,
     * for example a new stream that can be provided by {@link RetrieveStream#retrieve()}
     ...
     * for example new streams that can be provided by {@link RetrieveStream#retrieve()}
